...
WTag::IParticleKinematicHists::IParticleKinematicHists (std::string name) :
  HistogramManager(name, "")
{
}

WTag::IParticleKinematicHists::~IParticleKinematicHists () {}

StatusCode WTag::IParticleKinematicHists::initialize() {
...
StatusCode WTag::IParticleKinematicHists::execute( const xAOD::IParticleContainer* particles, float eventWeight ) {
...
StatusCode WTag::IParticleKinematicHists::execute( const xAOD::IParticle* particle, float eventWeight ) {
  //basic
