...
WTag::JetTagHists::JetTagHists (std::string name) :
  HistogramManager(name, "")
{
}

WTag::JetTagHists::~JetTagHists () {}

StatusCode WTag::JetTagHists::initialize() {
...
StatusCode WTag::JetTagHists::execute( const xAOD::JetContainer* jets, const xAOD::MissingET* met, float eventWeight ) {
  int numDecor(0);
...
StatusCode WTag::JetTagHists::execute( const xAOD::Jet* jet, float eventWeight ){
